...
module.exports = function(RED) {
    ...
    function TemplateNode(n) {
        ...
        this.partials = {
            header: '<!doctype html><html lang="en"><head><meta charset="utf-8"><title>The HTML5 Herald</title><link rel="stylesheet" href="css/styles.css?v=1.0"></head><body>  Helelo there@!</body></html>'
        };
        ...
        node.on("input", function(msg) {
            try {
                ...
                if (node.syntax === "mustache") {
                    value = mustache.render(node.template,new NodeContext(msg, node.context()),node.partials);
                } else {
                    value = node.template;
                }
